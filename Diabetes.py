...
df = pd.read_csv(r"C:\Users\lenovo\Desktop\Diabetes\diabetes.csv")
...
# Age vs Pregnancies
st.header('Pregnancy Count Graph')
fig_preg = plt.figure()
...
# Age vs Bp
st.header('Blood Pressure Value Graph')
fig_bp = plt.figure()
...
# Age vs St
st.header('Skin Thickness Value Graph')
fig_st = plt.figure()
